...
while status == True:
    ...
    while True:
        ...
        if char_1 in alpha and len(char_1) == 1:
            break
        else:
            print('')
    ...
    while True:
        ...
        if char_2 in alpha and len(char_2) == 1:
            break
        else:
            print('')
            print('Please only enter 1 letter or \'=\' if you don\'t know')
    ...
    while True:
        ...
        if char_3 in alpha and len(char_3) == 1:
            break
        else:
            print('')
            print('Please only enter 1 letter or \'=\' if you don\'t know')
    ...
    while True:
        ...
        if char_4 in alpha and len(char_4) == 1:
            break
        else:
            print('')
            print('Please only enter 1 letter or \'=\' if you don\'t know')
    ...
    while True:
        ...
        if char_5 in alpha and len(char_5) == 1:
            break
        else:
            print('')
            print('Please only enter 1 letter or \'=\' if you don\'t know')
